...
#define DIAMETER 2.3                    // 2.3 cm wheel diameter
#define CIRCUMFERENCE 7.2               // Distance traveled per revolution (C = pi*d)
#define DIST_PER_STEP 0.00105845        // Distance traveled per QEI pulse  (D = (pi*d)/(ONE_ROT*GEAR_RATIO))
#define CELL_SIZE 16                    // 16cm cell size
#define CELL_CENTER 15116               // Distance from cell center to next (Cent = cell_size/dist_per_step)
